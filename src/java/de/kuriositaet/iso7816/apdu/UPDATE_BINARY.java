...
/**
 * Class implementing the UPDATE BINARY command defined in ISO 7816-4
 *
 */
public class UPDATE_BINARY extends APDU {
	public UPDATE_BINARY () {
		super("UPDATE BINARY", (byte)0x00, (byte)0xD6);
	}
}
